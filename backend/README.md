...
## Project Structure
    ...
    ├── toplayer_mobile_app_36249  # Django project configurations
...
1. Clone this repo and `cd toplayer_mobile_app_36249`
...
2. Clone this repo and `cd toplayer_mobile_app_36249`
